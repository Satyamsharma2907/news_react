...
const Technology = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            ...
            await axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=8a46ade9d1994d958f4624f9c6dc9100`
    
            ).then((res)=>{
                console.log("category technoology");
